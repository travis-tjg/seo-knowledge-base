#!/usr/bin/env python3
"""
Update script for GBP Roast videos.

Checks for new videos from the GBP Roast channel and ingests any
...
# GBP Roast channel URL
GBP_ROAST_CHANNEL = "https://www.youtube.com/@GBPRoast/videos"

# Track processed videos
PROCESSED_FILE = Path(__file__).parent / "data" / "gbp_roast_processed.json"
...
def main(latest_only: bool = False, max_videos: int = None):
    ...
    console.print("[blue]Fetching video list from GBP Roast...[/blue]")
    videos = get_videos_from_channel(GBP_ROAST_CHANNEL)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Update GBP Roast videos in knowledge base")
